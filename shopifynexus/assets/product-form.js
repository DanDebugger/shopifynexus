  ...
  customElements.define('product-form', class ProductForm extends HTMLElement {
    ...
    onSubmitHandler(evt) {
      ...
      if (this.cart && typeof this.cart.open === 'function') {
        this.cart.classList.add('nexus-cart-drawer-updating');
      ...
      // Add selling plan only when the selling-plan helper exists on the page.
      ...
      fetch(`${routes.cart_add_url}`, config)
        ...
        .finally(() => {
          ...
          if (this.cart) this.cart.classList.remove('nexus-cart-drawer-updating');
